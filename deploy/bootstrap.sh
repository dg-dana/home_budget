...
# every session. APP_IMAGE and RESEND_API_KEY are rewritten by the deploy
# workflow, which takes the key from the repository secret of the same name.
DOMAIN=$DOMAIN
JWT_SECRET=$(openssl rand -hex 48)
APP_IMAGE=
RESEND_API_KEY=
# Both default off DOMAIN in docker-compose.yml. Set them only to override:
# MAIL_FROM=Home Budget <noreply@$DOMAIN>
